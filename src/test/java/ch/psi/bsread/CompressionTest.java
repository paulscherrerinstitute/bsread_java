...
public class CompressionTest {
   ...
   protected <V> Receiver<V> getReceiver() {
      return new Receiver<V>(new StandardMessageExtractor<V>(new MatlabByteConverter()));
   }
...
//               System.out.println(compression + " " + channelConfig.getType() + " "
//                     + Arrays.toString(channelConfig.getShape()) + " "
//                     + channelConfig.getEncoding());
//               System.out.println("\tTime: " + totRunTime + " avg: " + (totRunTime / (runs - warmup)));
//               System.out.println("\tCompression: " + ((double) totCompBytes / totBytes));
            }
         }
      }
   }
