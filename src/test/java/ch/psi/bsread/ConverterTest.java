...
public class ConverterTest {
	...
	public void test() {
		...
		assertEquals(Double.valueOf(1.0), byteConverter.getValue(buffer, "double", new int[] { 1 }), 0.000000000000001);
		buffer = byteConverter.getBytes("double", new double[] { 1.0, 2.0 }, ByteOrder.BIG_ENDIAN);
		assertArrayEquals(new double[] { 1.0, 2.0 }, byteConverter.getValue(buffer, "double", new int[] { 2 }), 0.000000000000001);
