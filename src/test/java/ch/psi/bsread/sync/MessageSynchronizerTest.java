...
public class MessageSynchronizerTest {
	...
	public void testMessageSynchronizer_LoadTest_1_100Hz() {
		...
		// -> similar to
		// SortedAsyncStream)
		testMessageSynchronizer_LoadTest(1, 1);
	}

	@Test
	public void testMessageSynchronizer_LoadTest_2_100Hz() {
		testMessageSynchronizer_LoadTest(2, 1);
	}

	@Test
	public void testMessageSynchronizer_LoadTest_3_100Hz() {
		testMessageSynchronizer_LoadTest(3, 1);
	}
	...
	public void testMessageSynchronizer_LoadTest_1_10Hz() {
		...
		// -> similar to
		// SortedAsyncStream)
		testMessageSynchronizer_LoadTest(1, 10);
	}

	@Test
	public void testMessageSynchronizer_LoadTest_2_10Hz() {
		testMessageSynchronizer_LoadTest(2, 10);
	}

	@Test
	public void testMessageSynchronizer_LoadTest_3_10Hz() {
		testMessageSynchronizer_LoadTest(3, 10);
	}

	public void testMessageSynchronizer_LoadTest(int nrOfChannels, int modulo) {
		...
		MessageSynchronizer<TestEvent> buffer = new MessageSynchronizer<>(completeQueue, nrOfEvents + 1, false, false, channels,
				(event) -> event.getChannel(), (event) -> event.getPulseId());
		...
		assertEquals(nrOfEvents, completeQueue.size());
	...
	private class LoadCallable implements Callable<Void> {
		...
		public LoadCallable(String channel, Timestamp globalTime, int startPulseId, int nrOfEvents, int interval,
				CountDownLatch waitForStart, MessageSynchronizer<TestEvent> buffer) {
