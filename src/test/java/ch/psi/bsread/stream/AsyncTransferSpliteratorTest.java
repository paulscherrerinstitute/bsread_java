...
public class AsyncTransferSpliteratorTest {
	...
	public void testPastFutureSize_0() {
		...
		StreamSection<Long> section = spliterator.getNext();
		assertEquals(1, spliterator.getSize());
		assertEquals(Long.valueOf(0), section.getCurrentValue());
		Iterator<Long> pastIter = section.getPastValues(true).iterator();
		assertFalse(pastIter.hasNext());

		pastIter = section.getPastValues(false).iterator();
		assertFalse(pastIter.hasNext());

		Iterator<Long> futureIter = section.getFutureValues(true).iterator();
		assertFalse(futureIter.hasNext());
		futureIter = section.getFutureValues(false).iterator();
		assertFalse(futureIter.hasNext());

		spliterator.onAvailable(Long.valueOf(1));
		assertEquals(2, spliterator.getSize());

		section = spliterator.getNext();
		assertEquals(2, spliterator.getSize());
		assertEquals(Long.valueOf(1), section.getCurrentValue());
		pastIter = section.getPastValues(true).iterator();
		assertFalse(pastIter.hasNext());

		pastIter = section.getPastValues(false).iterator();
		assertFalse(pastIter.hasNext());

		futureIter = section.getFutureValues(true).iterator();
		assertFalse(futureIter.hasNext());
		futureIter = section.getFutureValues(false).iterator();
		assertFalse(futureIter.hasNext());
		...
		section = spliterator.getNext();
		assertEquals(2, spliterator.getSize());
		assertEquals(Long.valueOf(2), section.getCurrentValue());
		pastIter = section.getPastValues(true).iterator();
		assertFalse(pastIter.hasNext());
		...
		section = spliterator.getNext();
		assertEquals(2, spliterator.getSize());
		assertEquals(Long.valueOf(3), section.getCurrentValue());
		pastIter = section.getPastValues(true).iterator();
		assertFalse(pastIter.hasNext());
		...
		section = spliterator.getNext();
		assertEquals(2, spliterator.getSize());
		assertEquals(Long.valueOf(4), section.getCurrentValue());
		pastIter = section.getPastValues(true).iterator();
		assertFalse(pastIter.hasNext());
		...
		CompletableFuture<StreamSection<Long>> future = CompletableFuture.supplyAsync(() -> spliterator.getNext());
		try {
	...
	public void testPastSize_2_Wait() {
		...
		CompletableFuture<StreamSection<Long>> future2 = CompletableFuture.supplyAsync(() -> spliterator.getNext());
		try {
	...
	public void testPastFutureSize_1() {
		...
		section = spliterator.getNext();
		assertEquals(3, spliterator.getSize());
		assertEquals(Long.valueOf(5), section.getCurrentValue());
		pastIter = section.getPastValues(true).iterator();
		assertTrue(pastIter.hasNext());
	...
	public void test_ValueOrder_01() throws InterruptedException {
		...
		StreamSection<Long> value = spliterator.getNext();
		assertEquals(Long.valueOf(0), value.getCurrentValue());
		value = spliterator.getNext();
		assertEquals(Long.valueOf(1), value.getCurrentValue());
	}
	...
	public void test_ValueOrder_02() throws InterruptedException {
		...
		assertEquals(Long.valueOf(1), value.getCurrentValue());
		value = spliterator.getNext();
		assertEquals(Long.valueOf(2), value.getCurrentValue());
	}
